...
{
public:
	virtual void sendMessage(BreachType) = 0;
};

class EmailMessager : public Messager
{
public:
...
void checkAndAlert(Messager* alertTarget, BatteryCharacter batteryChar, double temperatureInC);
